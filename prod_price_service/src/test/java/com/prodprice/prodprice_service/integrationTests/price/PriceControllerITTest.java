package com.prodprice.prodprice_service.integrationTests.price;
...
public class PriceControllerITTest
{
    ...
    {
        mockMvc.perform(get("/product/{productId}/price", 1)
                .contentType("application/json"))
                .andExpect(status().isOk());
    }

    @Test
    void test_getPrice_productDoesNotExist() throws Exception
    {
        mockMvc.perform(get("/product/{productId}/price", 0)
                .contentType("application/json"))
                .andExpect(status().isNotFound());
    }

    @Test
    void test_getPrice_verifyPrice() throws Exception
    {
        String expectedPriceList = "[{\"date_from\":\"2020-05-29T23:00:00.000+0000\",\"date_to\":\"2020-06-29T23:00:00.000+0000\",\"price\":12.54}," +
        ...
        MvcResult result = mockMvc.perform(get("/product/{productId}/price", 1)
                .contentType("application/json"))
